      ...
      <div className="bg-blue-600 py-16 md:py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-xl max-w-3xl mx-auto mb-10">
            Discover how FinTrak simplifies expense tracking, accelerates reimbursements, 
            and provides valuable insights for your business.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              FinTrak provides a comprehensive set of tools to manage your expenses efficiently.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
              ...
              <p className="text-gray-600 mb-6">
                Our advanced OCR technology automatically extracts and categorizes data from receipts, 
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Take your expense management to the next level with these powerful capabilities.
            </p>
          </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              FinTrak connects with your favorite business tools to create a unified workflow.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 justify-items-center">
            {Array.from({ length: 12 }).map((_, i) => (
              <div key={i} className="w-24 h-24 bg-white rounded-lg shadow-sm flex items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-3/4">
                <p className="text-xl text-gray-700 italic mb-6">
                  "FinTrak has transformed how we manage expenses. The automated approval process 
                  has cut our processing time by 75%, and the insights we get from the analytics 
                  have helped us optimize our spending across departments."
                </p>
                <div>
      ...
      <div className="bg-blue-600 py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses that have streamlined their expense management with FinTrak.
          </p>
          <Link to="/signup">
            <button className="px-8 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition shadow-md">
          ...
          <p className="mt-4 text-blue-200 text-sm">14-day free trial. No credit card required.</p>
        </div>
      </div>
    </div>
  );
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition group">
    ...
    <div className="mt-4">
      <Link to={`/features/${title.toLowerCase().replace(/\s+/g, '-')}`} className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
