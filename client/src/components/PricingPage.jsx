  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="bg-blue-600 py-16 md:py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-xl max-w-3xl mx-auto mb-10">
            Choose the plan that fits your business needs. All plans include our core expense management features.
          </p>
          
          {/* Billing Toggle */}
          <div className="inline-flex items-center bg-blue-700 p-1 rounded-lg mb-10">
            <button
              className={`px-4 py-2 rounded-md transition ${annual ? 'bg-white text-blue-600' : 'text-blue-100'}`}
              onClick={() => setAnnual(true)}
            >
              Annual
              {annual && <span className="ml-2 text-xs font-medium bg-green-100 text-green-800 px-2 py-0.5 rounded-full">Save 20%</span>}
            </button>
            <button
              className={`px-4 py-2 rounded-md transition ${!annual ? 'bg-white text-blue-600' : 'text-blue-100'}`}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link to={plan.name === "Enterprise" ? "/contact" : "/signup"}>
                    <button className={`w-full py-3 px-4 rounded-lg transition mb-6 ${
                      plan.popular 
                  ...
                  <h4 className="font-semibold text-gray-900 mb-3 text-sm uppercase tracking-wider">What's included:</h4>
                  ...
                  {plan.notIncluded.length > 0 && (
                    <>
                      <h4 className="font-semibold text-gray-900 mb-3 text-sm uppercase tracking-wider">Not included:</h4>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  {plans.map((plan, i) => (
                    <th key={i} className={`text-center p-4 ${plan.popular ? 'bg-blue-50' : 'bg-gray-50'}`}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {plans.map((plan, i) => (
                    <td key={i} className={`text-center p-4 border-t ${plan.popular ? 'bg-blue-50' : ''}`}>
                      <Link to={plan.name === "Enterprise" ? "/contact" : "/signup"}>
      ...
      <div className="bg-blue-600 py-16">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Streamline Your Expense Management?</h2>
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Start your 14-day free trial today and see how FinTrak can transform your expense process.
          </p>
          <Link to="/signup">
...
const FAQ = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-gray-200 pb-4">
      ...
      <div className={`mt-2 pr-8 transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
