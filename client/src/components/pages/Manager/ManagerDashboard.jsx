...
import { Search, ChevronUp, ChevronDown, Users, FileText, DollarSign, User, ArrowUpRight, ArrowDownRight } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(employee => 
        ...
        (employee._id && employee._id.slice(-6).toLowerCase().includes(searchTerm.toLowerCase()))
      );
    }
        ...
        <div className="space-y-6 p-6 bg-gray-50 min-h-screen">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Welcome back, {userData?.firstName || "Manager"}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
              <h2 className="text-lg font-medium text-gray-600 mb-2">Total Employees</h2>
              <div className="flex items-center">
                <span className="text-3xl font-bold text-blue-600">{stats.totalEmployees}</span>
                <Users className="h-8 w-8 ml-auto text-blue-500 opacity-75" />
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-yellow-500">
              <h2 className="text-lg font-medium text-gray-600 mb-2">Pending Expenses</h2>
              <div className="flex items-center">
                <span className="text-3xl font-bold text-yellow-600">{stats.pendingExpenses}</span>
                <FileText className="h-8 w-8 ml-auto text-yellow-500 opacity-75" />
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
              <h2 className="text-lg font-medium text-gray-600 mb-2">Total Expenses Amount</h2>
              <div className="flex items-center">
                <span className="text-3xl font-bold text-green-600">
                  ${stats.totalExpensesAmount.toLocaleString()}
                </span>
                <DollarSign className="h-8 w-8 ml-auto text-green-500 opacity-75" />
              </div>
            </div>
          </div>
                            ...
                            <tr key={employee._id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div className="text-sm text-gray-500">
                                  {employee._id ? employee._id.slice(-6) : 'N/A'}
                                </div>
                              </td>
                              {/* <td className="px-6 py-4 whitespace-nowrap">
                                <span
