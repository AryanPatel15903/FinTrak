  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-xl mx-auto mt-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Allocate financial resources to team members</p>
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-full p-3 pl-8 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              required
              disabled={loading}
            />
          </div>
